...
class Registro(QDialog, BeigeBg):
    ...
    def a(self):
        ...
        self.center_layout = CenterLayout(espacio=30)
        ...
        self.nombre_usuario = FormField(label="Nombre de usuario", tamano=12)
        self.error_username = TextoInicio(label="", tamano=12, error=True)
        self.error_username.setVisible(False)
        self.nombre = FormField(label="Nombre", tamano=12)
        self.apellidos = FormField(label="Apellidos", tamano=12)
        self.correo = FormField(label="Correo electrónico", tamano=12)
        self.error_correo = TextoInicio(label="", tamano=12, error=True)
        self.error_correo.setVisible(False)  
        self.contraseña = FormField(label="Contraseña", tamano=12, password=True)
        self.clinica = FormComboField(label="Clínica", tamano=12)
